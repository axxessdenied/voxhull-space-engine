...
namespace Chernobog.Studio.Common
{
	...
	public static class Mathx
	{
		...
		{
			return Lerp01(0, 100, probability) + UnityEngine.Random.value > 1;
		}
		...
		{
			return Lerp01(min, max, probability) + UnityEngine.Random.value > 1;
		}
		...
		public static Vector2 RandomPointInCircleEdge(Vector2 center, float radius, float thickness = 0)
		{
			...
			if (thickness > 0)
			{
				randomPoint = randomPoint.TranslatePointTowardPoint(center, UnityEngine.Random.Range(-thickness, thickness));
			}
			return randomPoint;
		}
